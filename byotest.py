...
# assert name != surname, "name should be equal to surname"
...
#     """
#     Check to ensure that a given collection does not contains a given value. Raises
#     AssertionError if `item` is found in `collection`
#     `collection` is the collection to be tested
#     `item` is the item that is being searched for
#     """    
